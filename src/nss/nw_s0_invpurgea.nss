...
//  Custom Check 3.5 Rules for Etheral
    else if(GetHasSpellEffect(SPELL_SANCTUARY, oTarget) == TRUE)
    {
        RemoveAnySpellEffects(SPELL_SANCTUARY, oTarget);
    }
    else if(GetHasSpellEffect(SPELL_ETHEREALNESS, oTarget) == TRUE)
    {
        RemoveAnySpellEffects(SPELL_ETHEREALNESS, oTarget);
    }
