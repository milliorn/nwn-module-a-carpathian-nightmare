...
void main()
{
    ...
    */
    ...
    object oTarget = GetFirstObjectInShape(SHAPE_SPHERE, 40.0f, lTarget, TRUE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
    ...
    while (GetIsObjectValid(oTarget))
    {
        ...
        fDelay = GetDistanceBetweenLocations(lTarget, GetLocation(oTarget))/40 + 0.5f;
           //Roll damage for each target
            int iCaster = GetCasterLevel(OBJECT_SELF) / 2;
            nDamage1 = d6(iCaster);
            nDamage2 = d6(iCaster);
            nDamage3 = d6(iCaster);
            nDamage4 = d6(iCaster);
       ...
       oTarget = GetNextObjectInShape(SHAPE_SPHERE, 40.0f, lTarget, TRUE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
    }
