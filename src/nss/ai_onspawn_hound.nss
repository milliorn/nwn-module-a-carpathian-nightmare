...
*/
    ...
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatorhound"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatorhound"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatorhound"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatorhound"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatormastiff"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatormastiff"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatormastiff"), OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectSwarm(TRUE, "baatormastiff"), OBJECT_SELF);
}
