...
// End of Spell Cast Hook
    ...
    effect eSearch = EffectSkillIncrease(FEAT_EPIC_SKILL_FOCUS_SEARCH, 4);
    effect eSetTrap = EffectSkillIncrease(SKILL_SET_TRAP, 4);
    ...
    eLink = EffectLinkEffects(eLink, eSetTrap);
