...
*/
    ...
    if (sLeft == "SU_")
    {
        ...
        string sModified = "Summoned ";
        DelayCommand(2.0, SetName(OBJECT_SELF, sModified + sName));
        return;
    }
    ...
    if (GetResRef(OBJECT_SELF) == "blckcobra002" ||
        ...
        GetResRef(OBJECT_SELF) == "grtcobra002"  ||
        GetResRef(OBJECT_SELF) == "hybcobra002"  ||
        GetResRef(OBJECT_SELF) == "spitcobra002")
    {
