...
void main()
{
    ...
    if (CIGetCurrentModMode(GetPCSpeaker()) != X2_CI_MODMODE_INVALID )
    {
        ...
        int nCost = 0; // GetLocalInt(oPC,"X2_TAILOR_CURRENT_COST");
        int nDC = 0; // GetLocalInt(oPC,"X2_TAILOR_CURRENT_DC");
        ...
        // Scarface's Modification
        DeleteLocalInt(oNew, "CRAFT_DUPLICATE");
    }
    else
    {
       ClearAllActions();
