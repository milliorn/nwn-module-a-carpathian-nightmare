...
void main()
{
    ...
    */
    ...
    if(nCasterLvl > 5)
    {
     ...
     object oArms = GetItemInSlot(INVENTORY_SLOT_ARMS, OBJECT_SELF);
    ...
    if(GetIsObjectValid(oMyWeapon))
    {
        ...
        if (nDuration>0)
        {
            ...
            AddGreaterEnhancementEffectAttackBonus(oArms, (HoursToSeconds(nDuration)), nCasterLvl);
            return;
        }
    }
    ...
    else if(IPGetIsRangedWeapon(oRanged))
    {
        ...
        if (nDuration>0)
        {
            ...
            AddGreaterEnhancementEffectAttackBonus(oRanged, (HoursToSeconds(nDuration)), nCasterLvl);
            return;
        }
    }
    else
