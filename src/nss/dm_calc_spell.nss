...
void main()
{
    ...
    ModSpellItem(GetFirstItemInInventory(GetObjectByTag("omegaforge" + GetStringRight(GetTag(OBJECT_SELF),1))),
                ...
                OBJECT_SELF,GetLocalInt(OBJECT_SELF,"SpellLevel"),GetLocalInt(OBJECT_SELF,"Mods"),
                GetLocalInt(OBJECT_SELF,"MODCODE"));
